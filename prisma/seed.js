    ...
    const meals = [
        {
            ...
            dietTypes: [client_1.DietType.STANDARD, client_1.DietType.VEGETARIAN, client_1.DietType.KETO],
        ...
        },
        {
            ...
            dietTypes: [client_1.DietType.STANDARD, client_1.DietType.PALEO, client_1.DietType.MEDITERRANEAN],
            allergens: [],
            prepTimeMins: 20,
        },
        {
        ...
        },
        {
            ...
            dietTypes: [client_1.DietType.STANDARD, client_1.DietType.VEGETARIAN],
        ...
        },
        {
            ...
            dietTypes: [client_1.DietType.STANDARD, client_1.DietType.VEGETARIAN, client_1.DietType.VEGAN, client_1.DietType.MEDITERRANEAN],
            allergens: ['sesame'],
            prepTimeMins: 30,
        },
        {
            ...
            dietTypes: [client_1.DietType.STANDARD, client_1.DietType.VEGETARIAN, client_1.DietType.VEGAN, client_1.DietType.KETO, client_1.DietType.PALEO],
            allergens: ['nuts'],
            prepTimeMins: 0,
        },
    ];
